...
export const metadata: Metadata = {
  ...
  description: "Scalable SaaS product development from architecture and UI to APIs, databases, authentication, deployment, and growth-ready performance.",
  alternates: { canonical: "/services/saas-development" },
  openGraph: {
    title: "SaaS Development Services | Shells Technologies",
    description: "Scalable SaaS product development from architecture and UI to APIs, databases, authentication, deployment, and growth-ready performance.",
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="section-padding mx-auto max-w-6xl">
        ...
        <div className="mt-16 max-w-4xl">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-purple-300">SaaS Development</p>
          <h1 className="mt-5 text-4xl font-black tracking-tight sm:text-6xl">SaaS Development Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-400">Scalable SaaS product development from architecture and UI to APIs, databases, authentication, deployment, and growth-ready performance.</p>
          <div className="mt-8 flex flex-wrap gap-3">
            <span className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-zinc-300">Next.js</span><span className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-zinc-300">Node.js</span><span className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-zinc-300">PostgreSQL</span><span className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-zinc-300">APIs</span>
          </div>
        </div>
